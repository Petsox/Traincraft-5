...
public enum EnumTrains implements TrainRecord {
	...
	Class43("Class43", EntityLocoDieselClass43.class, ItemIDs.minecartClass43.item, "diesel", 2250, 238, 0, 25, 0, 180, 0.7, 0.7, 13000, TraincraftUtil.getBytesFromColors(new String[] {"White", "Blue", "Brown", "Green", "Red", "Cyan", "LightBlue", "Orange", "Yellow", "Purple", "Pink", "Black", "Grey", "LightGrey", "Magenta", "Lime", "Skin17", "Skin18", "Skin19", "Skin20"}), 0, -3.15,"Pack: B.I.P."),
	Class90("Class90", EntityElectricClass90.class, ItemIDs.minecartClass90.item, "electric", 5000, 178, 0,60, 0, 100, 0.75, 0.7, 1000, TraincraftUtil.getBytesFromColors(new String[] {"Black", "Green", "LightGrey", "Grey", "Pink", "Red", "White", "Magenta", "Brown"}), 18, -2.77,"Pack: B.I.P."),
	...
	Class321("Class321", EntityElectricClass321.class, ItemIDs.minecartClass321.item, "electric", 1438, 178, 0,60, 0, 100, 0.7, 0.7, 1000, TraincraftUtil.getBytesFromColors(new String[] {"Purple", "Grey", "White", "Red", "Green", "Blue", "LightGrey"}), 18, -4,"Pack: B.I.P."),
	Class321Motor("Class321Motor", EntityPassengerClass321Panto.class, ItemIDs.minecartClass321Panto.item, "passenger", 0, 0, 3,0 , 0, 0, 0,0,0, TraincraftUtil.getBytesFromColors(new String[] {"Purple", "Grey", "White", "Red", "Green", "Blue", "LightGrey"}), 0, 0,"Pack: B.I.P."),
	Class321Coach("Class321Coach", EntityPassengerClass321Coach.class, ItemIDs.minecartClass321Coach.item, "passenger", 0, 0, 3,0 , 0, 0, 0,0,0,TraincraftUtil.getBytesFromColors(new String[] {"Purple", "Grey", "White", "Red", "Green", "LightGrey"}),0,0,"Pack: B.I.P."),
	...
	Class401Tail("Class401Tail", EntityPassengerClass401Tail.class, ItemIDs.minecartClass401Tail.item, "passenger", 0, 0, 1, 0, 0, 0, 0, 0, 0,  TraincraftUtil.getBytesFromColors(new String[]{"Blue", "Lime", "Green", "Grey"}), 18, 0, "Pack: B.I.P."),
	...
	locoDieselCD754("CD754", EntityLocoDieselCD754.class,  ItemIDs.minecartCD754.item,"diesel", 1974, 101, 0, 60, 0, 170, 0.66, 0.96, 5000, TraincraftUtil.getBytesFromColors(new String[]{"Red"}), 13,  -3),
	...
	M8DNF1Middlelong("M8DNF1Middlelong", EntityPassengerM8DNF1MiddleLong.class, ItemIDs.minecartM8DNF1Middlelong.item, "passenger", 0, 0, 1,0, 0, 0, 0, 0, 0, TraincraftUtil.getBytesFromColors(new String[] {"Blue"}), 18, 0, "Pack: Trams In Motion"),
	M8DNF1Middleshort("M8DNF1Middleshort", EntityPassengerM8DNF1MiddleShort.class, ItemIDs.minecartM8DNF1Middleshort.item, "passenger", 0, 0, 1,0, 0, 0, 0, 0, 0, TraincraftUtil.getBytesFromColors(new String[] {"Blue"}), 18, 0, "Pack: Trams In Motion"),
